...
CREATE TABLE estudiante (
	id_usuario	INT PRIMARY KEY REFERENCES usuario(id_user) ON DELETE CASCADE,
...
-- ------------------------------------------------------------
-- ITINERARIOS (vuelos abiertos con fecha y hora)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- PERMISOS FINALES (por si se corren las tablas antes que el 00)
-- ------------------------------------------------------------
